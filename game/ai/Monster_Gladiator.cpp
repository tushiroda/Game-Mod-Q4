...
void Cmd_S(const idCmdArgs& args) {
#ifndef _MPBETA
...
stateResult_t rvMonsterGladiator::State_Killed ( const stateParms_t& parms ) {
	...
	switch (r) {
	case 0:
		Cmd_S(idCmdArgs("spawn weaponmod_hyperblaster_bounce1", true));
		break;
	case 1:
		Cmd_S(idCmdArgs("spawn weaponmod_nailgun_power", true));
		break;
	case 2:
		Cmd_S(idCmdArgs("spawn weaponmod_shotgun_ammo", true));
		break;
	case 3:
		Cmd_S(idCmdArgs("spawn weaponmod_machinegun_ammo", true));
		break;
	case 4:
